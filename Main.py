...
main = tkinter.Tk()
main.title("Recommendation system include sentiment analysis with customer product reviews using ml") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Recommendation system include sentiment analysis with customer product reviews using ml')
